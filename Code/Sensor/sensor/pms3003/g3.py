...
class g3sensor():
    ...
    def check_keyword(self):
        ...
        while True:
            ...
            token_hex = codecs.encode(token, 'hex').decode('ascii')
            ...
            if token_hex == '42':
                ...
                token2_hex = codecs.encode(token2, 'hex').decode('ascii')
                ...
                if token2_hex == '4d':
                    ...
                    token3_hex = codecs.encode(token3, 'hex').decode('ascii')
                    if token3_hex == '4d':
                        if debug: print("get 4d")
                        return True
    ...
    def read_data(self):
        ...
        data_hex = codecs.encode(data, 'hex').decode('ascii')
